      ...
      <View style={{backgroundColor:'#fff',flex:1}}>
          <View style={{height:42,backgroundColor:'#08BBF9',flexDirection:'row'}}>
              ...
              <View style={{flex:1,alignItems:'center',justifyContent:'center'}}>
                 <Text style={{fontSize:18,color:'white',alignSelf:'center',marginTop:22}}>房源详情</Text>
              </View>
              <TouchableOpacity style={styles.width36} onPress={this.itemActionIndex.bind(this)}>
                 <Text style={{fontSize:14,color:'white',fontWeight:'bold',marginTop:22}}>登录</Text>
              </TouchableOpacity>
           </View>
           ...
           <View style={styles.item}>
             ...
             <View style={styles.width30}>
              <Text style={{fontSize:14,color:'#fff',fontWeight:'bold',}}>小   区   信   息</Text>
             </View>
