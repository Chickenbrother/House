...
import Chaddz_content from './chaddz_content';
export default class Chaddz extends Component {
    constructor(props){
          super(props);
    }
            ...
            <View style={styles.container}>
              <View style={{height:42,backgroundColor:'#08BBF9',flexDirection:'row'}}>
                  ...
                  <View style={{flex:1,alignItems:'center',justifyContent:'center'}}>
                     <Text style={{fontSize:18,color:'white',alignSelf:'center',marginTop:22}}>查档地址</Text>
                  </View>
               </View>
...
class List extends Component {
    ...
    fetchData() {
        var classes = "http://121.41.33.67:8080/HousingService/api/convenient/address/list/4";
            fetch(classes)
