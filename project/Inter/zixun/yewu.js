          ...
          <View style={{height:42,backgroundColor:'#08BBF9',flexDirection:'row'}}>
                  <TouchableOpacity onPress={this.back.bind(this)} style={{marginLeft:6,width:24,height:36,justifyContent:'center',marginTop:12}}>
                    ...
                    <View style={{flex:1,alignItems:'center',justifyContent:'center'}}>
                       <Text style={{fontSize:18,color:'white',alignSelf:'center',marginTop:16}}>房产业务咨询</Text>
                    </View>
                </View>
           <ScrollView showsVerticalScrollIndicator={true}
             ...
             <View >
               <PickerIOS
                  ...
                  <PickerIOS.Item label="住房保障及制度改革" value="51306" />
                  <PickerIOS.Item label="物业管理" value="51301" />
                  <PickerIOS.Item label="物业维修基金管理" value="51302" />
                  <PickerIOS.Item label="房产交易产权管理" value="51304" />
                  <PickerIOS.Item label="城市房屋拆迁管理" value="51305" />
                  <PickerIOS.Item label="白蚁防治" value="51307" />
                  <PickerIOS.Item label="房产档案管理" value="51308" />
                  <PickerIOS.Item label="房产信息服务" value="51309" />
                  <PickerIOS.Item label="房产市场管理" value="51310" />
                  <PickerIOS.Item label="房屋安全鉴定" value="51311" />
                  <PickerIOS.Item label="综合类" value="51312" />
                </PickerIOS>
              </View>
