    ...
    render() {
        ...
        return (
            <View style={styles.container}>
               ...
               <View style={{height:124,marginTop:0}}>
                        ...
                        <View style={{flexDirection:'row'}}>
                          ...
                          <TouchableOpacity onPress={()=>this.itemActionIndex(0)}>
                            <View style={{width:partwidth}}>
                                ...
                                <Text style={{marginTop:5,textAlign:'center',fontSize:11,color:'#555555'}}>服务热线</Text>
                            </View>
                          </TouchableOpacity>
                          ...
                          <View style={{width:partwidth}}>
                              ...
                              <Text style={{marginTop:5,textAlign:'center',fontSize:11,color:'#555555'}}>应急维修</Text>
                          </View>
                          </TouchableOpacity>
                          ...
                          <View style={{width:partwidth}}>
                              ...
                              <Text style={{marginTop:5,textAlign:'center',fontSize:11,color:'#555555'}}>白蚁防治</Text>
                          </View>
                          </TouchableOpacity>
                          ...
                          <View style={{width:partwidth}}>
                              ...
                              <Text style={{marginTop:5,textAlign:'center',fontSize:11,color:'#555555'}}>查档地址</Text>
                          </View>
                          </TouchableOpacity>
                         </View>
                         ...
                         <View style={{flexDirection:'row',marginTop:10}}>
                            ...
                            <View style={{width:partwidth}}>
                                ...
                                <Text style={{marginTop:5,textAlign:'center',fontSize:11,color:'#555555'}}>保障房</Text>
                            </View>
                            </TouchableOpacity>
                            ...
                            <View style={{width:partwidth}}>
                                ...
                                <Text style={{marginTop:5,textAlign:'center',fontSize:11,color:'#555555'}}>自助换房</Text>
                            </View>
                            </TouchableOpacity>
                            ...
                            <View style={{width:partwidth}}>
                                ...
                                <Text style={{marginTop:5,textAlign:'center',fontSize:11,color:'#555555'}}>政务动态</Text>
                            </View>
                            </TouchableOpacity>
                            ...
                            <View style={{width:partwidth}}>
                                ...
                                <Text style={{marginTop:5,textAlign:'center',fontSize:11,color:'#555555'}}>我要咨询</Text>
                            </View>
                            </TouchableOpacity>
                        </View>
              </View>
              ...
              <View style={styles.contentContainer}>
                      <View style={styles.item}>
                          ...
                          <TouchableOpacity onPress={()=>this.itemActionIndex(9)}>
                            <View numberOfLines={1} style={{marginLeft:totalWidth-160}}>
                                  <Text style={{color:'#929292',fontSize:12}}>更多</Text>
                            </View>
                          </TouchableOpacity>
                      </View>
                  ...
                  <ScrollView  showsVerticalScrollIndicator={true}
                     ...
                     <List1 navigator={this.props.navigator} />
                  </ScrollView>
              </View>
      </View>
        )
