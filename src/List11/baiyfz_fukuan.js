          ...
          <View style={{height:36,backgroundColor:'#08BBF9',flexDirection:'row'}}>
           ...
           <View style={{marginLeft:10,marginRight:10}}>
               <View style={styles.row}>
                 ...
                 <TextInput style={styles.input1} underlineColorAndroid={'transparent'} multiline={true} numberOfLines={2}
             ...
             <View style={styles.row}>
               ...
               <View style={styles.row}>
                 ...
                 <TextInput style={styles.input1} multiline={true} underlineColorAndroid={'transparent'} placeholder="请输入"
