...
export default class Zhengwdt extends Component {
  constructor(props) {
    super(props);
      ...
      <View style={{backgroundColor:'#fff',flex:1}}>
          <View style={{height:36,backgroundColor:'#08BBF9',flexDirection:'row'}}>
             ...
             <View style={{flex:1,alignItems:'center',justifyContent:'center'}}>
                <Text style={{fontSize:18,color:'white',alignSelf:'center'}}>政务动态</Text>
             </View>
          </View>
          <WebView
            source={{uri:'http://121.41.33.67:8080/HousingService/page/information/GovernmentAffairs.html'}}
