...
var fwnm,szcq,xqname,sqrxm7,fwjg,syqzid,sqrxm3,cqzmz,cqzid,crlx;
import Baiyfz_yewu_content1_Page from './baiyfz_yewu_content1_Page';
export default class Baiyfz_yewu_content1_Page1 extends Component {
...
_tijiao(){
  ...
  var kysj=  this.state.text;
  var kysj1=  this.state.text;
  var czlx = "插入";
	var classes = "http://121.41.33.67:8080/HousingService/api/byfz/check/info";
  var outData ={"ywlb":terpageNo,"lxr":lxr,"name":cqzmz,"address":address,"szcq":szcq,"xqname":xqname,
 							"lxdh":lxdh,"lxsj":lxsj,"syqzid":syqzid,"cqzh":cqzid,"fwaddress":sqrxm7,"area":area,"fwjg":fwjg,"cqxz":cqxz,
 							"whqk":whqk,"bz":bz,"ffsj":ffsj,"bytc":bytc,
              "kysj":kysj,"kysj1":kysj1,"fwcode":fwnm,"czlx":czlx};
    if(!lxr || !cqxz || !ffsj || !bytc || !area || !lxdh || !lxsj || !address || !whqk || !bz|| !kysj|| !kysj1){
        ...
        fetch(classes,{
            ...
            .then((Data) =>{
                    if(Data.result ==="1" ){
                      ...
                      var uploadno=Data.slbh;
                      this.handleResponse(uploadno);
                    } else {
