...
let sourceData = [
    {name: '张一', description: '今天天气不错', group: 'Family'},
    {name: '张二', description: '今天天气不错', group: 'Family'},
    {name: '张三', description: '今天天气不错', group: 'Work'},
    {name: '张四', description: '今天天气不错', group: 'Family'},
    {name: '张五', description: '今天天气不错', group: 'Work'},
    {name: '张六', description: '今天天气不错', group: 'Work'},
    {name: '张七', description: '今天天气不错', group: 'Work'},
    {name: '张八', description: '今天天气不错', group: 'Family'},
    {name: '张九', description: '今天天气不错', group: 'Family'},
    {name: '张三', description: '今天天气不错', group: 'Work'},
]

export default class lten extends Component {
